...
class grocerry extends StatefulWidget {
  grocerry({Key? key, required this.searchQuery}) : super(key: key);
  final String searchQuery;

  @override
  State<grocerry> createState() => _FoodState();
}

class _FoodState extends State<grocerry> {
  final List<Map<String, String>> grocerryitems = [
    {
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> filteredGrocerryItem = grocerryitems
    ...
    return Container(
      child: GridView.builder(
        ...
        itemCount: filteredGrocerryItem.length,
        itemBuilder: (context, index) {
          final item = grocerryitems[index];
          return Items(
            image: item['image']!,
            name: item['name']!,
            time: item['time']!,
